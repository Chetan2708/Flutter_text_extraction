...
import 'package:test/Screen/EntityExtractionPage.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Text Extraction'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    // by the _incrementCounter method above.x
    //
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            const Text(
              'Click on the Scan button to scan your picture',
            ),
          ],
        ),
      ),
